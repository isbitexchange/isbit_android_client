...
/**
 * Created by Sebastian Acosta Checa on 14-1-14.
 */
...
public class BitOrder {
    ...
    private Double orderMxnPrice = 0.0;
    ...
    private Double processedMxnPrice = 0.0;
    ...
    public Double getOrderMxnPrice() {
        return orderMxnPrice;
    }

    public void setOrderMxnPrice(Double orderMxnPrice) {
        this.orderMxnPrice = DoubleUtils.toFourDecimal(orderMxnPrice);
    }

    public Double getProcessedMxnPrice() {
        return processedMxnPrice;
    }

    public void setProcessedMxnPrice(Double processedMxnPrice) {
        this.processedMxnPrice = DoubleUtils.toFourDecimal(processedMxnPrice);
    ...
    public String toString() {
        return "BitOrder{" +
                ...
                ", processedMxnPrice=" + processedMxnPrice +
