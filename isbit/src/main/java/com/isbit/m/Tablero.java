        ...
        Log.i(TAG, "onActivityResult(requestCode="+requestCode+", resultCode, data="+data+")");
            if (result != null) {
                ...
                try {
                    ...
                    ds.save_key_value_pair( com.isbit.m.DS.secret_key, secret_key);
                    ds.save_key_value_pair( com.isbit.m.DS.url_host, url_host);
                    ds.save_key_value_pair( com.isbit.m.DS.url_schema, url_schema);
                    ds.close();
