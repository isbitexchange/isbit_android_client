                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                TextView ticker_tv = (TextView) getActivity().findViewById(com.isbit.m.R.id.ticker_tv);
                                ticker_tv.setText(
            ...
            public void run() {
                ...
                rootView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        available_btc_label.setText(String.format(Locale.getDefault(),"%.8f",asset.getAvailableBtc()));
                        ...
                        activated.setText(getString(R.string.member_is_active)+ ds.query_database_key( "activated"));
