...
/**
 * <p>Encapsulates the result of a barcode scan invoked through {@link IntentIntegratorISBIT}.</p>
 *
 * @author Sean Owen
 */
public final class IntentResultISBIT {
    ...
    IntentResultISBIT(String contents,
                      String formatName,
                      byte[] rawBytes,
                      Integer orientation,
