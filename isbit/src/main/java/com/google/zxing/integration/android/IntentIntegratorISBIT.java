...
public class IntentIntegratorISBIT {

    public static int REQUEST_CODE = 0x0000c0de; // Only use bottom 16 bits
    private static final String TAG = IntentIntegratorISBIT.class.getSimpleName();
     ...
     */
    public IntentIntegratorISBIT(Activity activity) {
     ...
     */
    public IntentIntegratorISBIT setCaptureActivity(Class<?> captureActivity) {
     ...
     *                 of an {@link Activity}
     */
    public static IntentIntegratorISBIT forSupportFragment(android.support.v4.app.Fragment fragment) {
        IntentIntegratorISBIT integrator = new IntentIntegratorISBIT(fragment.getActivity());
    ...
    public static IntentIntegratorISBIT forFragment(Fragment fragment) {
        IntentIntegratorISBIT integrator = new IntentIntegratorISBIT(fragment.getActivity());
    ...
    public final IntentIntegratorISBIT addExtra(String key, Object value) {
     ...
     */
    public final IntentIntegratorISBIT setPrompt(String prompt) {
        if (prompt != null) {
     ...
     */
    public IntentIntegratorISBIT setOrientationLocked(boolean locked) {
     ...
     * @return this
     */
    public IntentIntegratorISBIT setCameraId(int cameraId) {
        if (cameraId >= 0) {
     ...
     * @return this
     */
    public IntentIntegratorISBIT setBeepEnabled(boolean enabled) {
     ...
     * @return this
     */
    public IntentIntegratorISBIT setBarcodeImageEnabled(boolean enabled) {
     ...
     * @return this
     */
    public IntentIntegratorISBIT setDesiredBarcodeFormats(Collection<String> desiredBarcodeFormats) {
     ...
     */
    public IntentIntegratorISBIT setTimeout(long timeout) {
     ...
     * else an {@link IntentResultISBIT} containing the result of the scan. If the user cancelled scanning,
     * the fields will be null.
     */
    public static IntentResultISBIT parseActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                return new IntentResultISBIT(contents,
                        formatName,
                        rawBytes,
                        orientation,
